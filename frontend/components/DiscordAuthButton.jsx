...
export default function DiscordAuthButton() {
  const { session, loading } = useDiscordAuth()
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white">
            ...
            <span className="ml-2 px-2 py-1 bg-yellow-500 text-black rounded text-xs">
              $CALVIN Whale
            </span>
          </span>
        </div>
  ...
  return (
    <button 
      ...
      className="px-6 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-lg transition-colors flex items-center gap-2 cursor-pointer"
    >

...
pub fn trade(ctx: Context<Trade>, data: Vec<u8>) -> Result<()> {
    ...
    let destination_balance_after = ctx.accounts.destination_token_account.reload()?;
    let amount_out = destination_balance_after.amount
    ...
    let new_nav = utils::current_nav_usdc(
        ...
        &[
            ...
            destination_balance_after.clone(),
        ],
